// scripts/parse_complex_crops.cjs
const fs = require('fs');
const path = require('path');

const BASE_MATH_CROPS = 'c:/mentos_os_clean/public/math_crops/(004)복소수';
...
function parseStage(stageName) {
  ...
  console.log(`\n=== Processing Complex Numbers (복소수) ${stageName} ===`);
