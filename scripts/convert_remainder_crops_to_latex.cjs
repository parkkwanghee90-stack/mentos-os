...
const BASE_DIR = path.join(__dirname, '../public/math_crops/(002)항등식과나머지정리');
const TEXT_DB_PATHS = [
...
async function run() {
  const stages = [
    { name: '2단계', dbKey: '(002)항등식과나머지정리2단계' },
    { name: '3단계', dbKey: '(002)항등식과나머지정리3단계' },
    { name: '4단계', dbKey: '(002)항등식과나머지정리4단계' }
  ];
