...
const P = {
  ...
  '008': review('p·f(π/16)·g(π/8)의 값을 구합니다 (반원·평행선 넓이비).', '지름 AB=4, ∠CAB=θ. S(θ)=△QDB, T(θ)=△PQC. (가)(나)(다) 블랭크.', [circle([0, 0], 2, MAIN), point([-2, 0], 'A'), point([2, 0], 'B'), point([0, 0], 'O')], '\\frac{\\sqrt{2}}{?}\\pi'),
  ...
  '021': review('사각형 ABCD 넓이 q/p√3의 p+q를 구합니다.', 'AB=a, DA=2a, ∠DAB=2π/3, BE:ED=3:4. △DAB 외접원 r=1.', [tri([[1, 3], [0, 0], [4, 0]]), point([0, 0], 'A')]),
  ...
  '028': review('50 sinθ cosθ의 값을 구합니다.', 'BE=1, EC=5, AE=√10, AC=3√5, ∠AEC=θ. (전체 그림 의존)', [tri([[1.5, 3], [0, 0], [6, 0]]), point([1, 0], 'E', HL)], null, 'short_answer'),
