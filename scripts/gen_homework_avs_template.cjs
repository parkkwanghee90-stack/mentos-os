...
const UNIT_TEMPLATES = {
  ...
  '수학상_01다항식_통합숙제': {
    type: 'algebra',
    P: '다항식의 사칙연산과 곱셈공식을 이용하여 식을 전개·정리하고, 곱셈공식의 변형으로 식의 값을 구합니다.',
    C: '곱셈공식을 정방향(전개)뿐 아니라 역방향(변형)으로도 활용하는 것이 핵심입니다. 대칭식은 기본대칭식(합·곱)으로 바꿔 접근합니다.',
    B: '곱셈공식과 그 변형:\n\n1) $$(a\\pm b)^2 = a^2 \\pm 2ab + b^2$$\n2) $$(a+b)(a-b) = a^2 - b^2$$\n3) $$(a\\pm b)^3 = a^3 \\pm 3a^2b + 3ab^2 \\pm b^3$$\n4) $$a^3 \\pm b^3 = (a\\pm b)(a^2 \\mp ab + b^2)$$\n5) 변형: $$a^2+b^2 = (a+b)^2 - 2ab$$, $$a^3+b^3=(a+b)^3-3ab(a+b)$$',
  },
  '수학상_02나머지정리_통합숙제': {
    type: 'algebra',
    P: '항등식의 성질, 나머지정리와 인수정리를 이용하여 미정계수를 구하고 다항식을 나눈 나머지를 구합니다.',
    C: '항등식은 계수비교법 또는 수치대입법으로 처리합니다. 나머지를 구할 때는 나누는 식이 0이 되는 값을 대입하는 것이 핵심 전략입니다.',
    B: '핵심 정리:\n\n1) 나머지정리: 다항식 $$f(x)$$를 $$(x-a)$$로 나눈 나머지는 $$f(a)$$\n2) 인수정리: $$f(a)=0 \\iff (x-a)$$는 $$f(x)$$의 인수\n3) $$(ax-b)$$로 나눈 나머지는 $$f\\!\\left(\\frac{b}{a}\\right)$$\n4) 항등식: 양변의 동류항 계수가 모두 같음 (계수비교법·수치대입법)',
  },
  '수학상_03인수분해_통합숙제': {
    type: 'algebra',
    P: '복잡한 다항식을 공식·치환·인수정리를 이용하여 인수분해합니다.',
    C: '공통부분은 치환하고, 차수가 높거나 공식이 안 보이면 인수정리로 인수를 하나 찾은 뒤 조립제법으로 차수를 낮춥니다. 여러 문자가 섞이면 한 문자에 대해 내림차순 정리합니다.',
    B: '인수분해 전략:\n\n1) $$a^3 \\pm b^3 = (a \\pm b)(a^2 \\mp ab + b^2)$$\n2) $$a^3+b^3+c^3-3abc = (a+b+c)(a^2+b^2+c^2-ab-bc-ca)$$\n3) 치환: 공통부분을 한 문자로 치환\n4) 인수정리 + 조립제법으로 고차식 분해\n5) 복이차식 $$x^4+ax^2+b$$: $$A^2-B^2$$ 꼴로 변형',
  },
  '수학상_04복소수_통합숙제': {
    type: 'algebra',
    P: '복소수의 사칙연산, 켤레복소수의 성질, $$i$$의 거듭제곱을 이용하여 식의 값을 구합니다.',
    C: '$$i^2=-1$$을 기준으로 $$i$$의 거듭제곱은 4주기로 반복됩니다. 켤레복소수의 합·곱은 실수가 되는 성질과 분모의 실수화가 핵심입니다.',
    B: '복소수의 성질:\n\n1) $$i^2 = -1$$, $$i$$의 거듭제곱은 $$i, -1, -i, 1$$ 의 4주기\n2) 켤레: $$\\overline{a+bi}=a-bi$$, $$z\\bar{z}=a^2+b^2$$ (실수)\n3) $$z+\\bar{z}=2a$$ (실수)\n4) 분모 실수화: 분모의 켤레를 분자·분모에 곱함\n5) $$z$$가 실수 $$\\iff z=\\bar{z}$$, 순허수 $$\\iff z=-\\bar{z}\\,(z\\neq0)$$',
  },
  '수학상_05이차방정식_통합숙제': {
    type: 'algebra',
    P: '이차방정식의 판별식, 근과 계수의 관계를 이용하여 근의 조건과 식의 값을 구합니다.',
    C: '실근·허근·중근의 판단은 판별식, 두 근의 합·곱이 필요한 식은 근과 계수의 관계로 접근합니다. 계수가 실수일 때 허근은 켤레로 나타납니다.',
    B: '이차방정식 $$ax^2+bx+c=0$$:\n\n1) 근의 공식: $$x = \\dfrac{-b \\pm \\sqrt{b^2-4ac}}{2a}$$\n2) 판별식 $$D=b^2-4ac$$: $$D>0$$ 서로 다른 두 실근, $$D=0$$ 중근, $$D<0$$ 서로 다른 두 허근\n3) 근과 계수: $$\\alpha+\\beta = -\\dfrac{b}{a},\\ \\alpha\\beta = \\dfrac{c}{a}$$\n4) 두 근이 $$\\alpha,\\beta$$인 이차방정식: $$a(x-\\alpha)(x-\\beta)=0$$',
  },
  '수학상_06이차함수1번숙제_통합숙제': {
    type: 'algebra',
    P: '이차함수의 그래프(꼭짓점·축·교점)와 이차방정식·이차함수의 관계를 분석합니다.',
    C: '표준형 $$y=a(x-p)^2+q$$로 변형하여 꼭짓점과 축을 파악하고, 그래프와 $$x$$축의 위치 관계는 판별식으로 해석합니다.',
    B: '이차함수의 그래프:\n\n1) 표준형: $$y=a(x-p)^2+q$$, 꼭짓점 $$(p,q)$$, 축 $$x=p$$\n2) $$x$$축과의 교점 개수는 $$D=b^2-4ac$$의 부호로 판정\n3) $$a>0$$ 아래로 볼록(최소), $$a<0$$ 위로 볼록(최대)\n4) 그래프와 직선의 교점: 연립하여 이차방정식의 판별식 이용',
  },
  '수학상_07이차함수2번숙제_통합숙제': {
    type: 'algebra',
    P: '제한된 범위에서 이차함수의 최댓값·최솟값을 구하고 활용 문제에 적용합니다.',
    C: '꼭짓점이 정의역 안에 있는지에 따라 최대·최소 위치가 달라집니다. 축의 위치와 구간 끝값을 함께 비교하는 것이 핵심입니다.',
    B: '이차함수의 최대·최소:\n\n1) 정의역이 실수 전체: 꼭짓점에서 최대 또는 최소\n2) 제한된 구간 $$[m,n]$$: 꼭짓점이 구간 내부면 꼭짓점값과 양 끝값 비교, 외부면 양 끝값만 비교\n3) 표준형 $$y=a(x-p)^2+q$$로 변형 후 축 $$x=p$$의 위치 판단\n4) 공통부분 치환 후 범위(치역)에 주의',
  },
  '수학상_08이차함수3번숙제_통합숙제': {
    type: 'algebra',
    P: '이차함수와 직선의 위치 관계, 이차방정식의 근의 분리 조건을 이용하여 미지수의 범위를 구합니다.',
    C: '근의 분리는 판별식 $$D$$, 축의 위치, 경계값에서의 함수값 부호 세 가지를 동시에 고려해야 합니다.',
    B: '근의 분리 (이차함수 $$f(x)$$):\n\n1) 두 근이 모두 $$k$$보다 큼: $$D\\ge0,\\ f(k)>0,\\ $$ 축 $$>k$$\n2) 두 근 사이에 $$k$$: $$f(k)<0$$\n3) 두 근이 $$p,q$$ 사이: $$D\\ge0,\\ f(p)>0,\\ f(q)>0,\\ p<$$축$$<q$$\n4) 그래프와 직선: 연립 후 판별식으로 접·교·만나지 않음 판정',
  },
  '수학상_09고차방정식_통합숙제': {
    type: 'algebra',
    P: '삼·사차방정식을 인수분해·치환으로 풀고, 켤레근·근과 계수의 관계를 이용하여 근의 조건을 구합니다.',
    C: '인수정리·조립제법으로 차수를 낮추거나, 복이차식은 치환합니다. 삼차방정식의 근과 계수의 관계, 켤레근의 성질이 핵심 도구입니다.',
    B: '고차방정식:\n\n1) 인수정리 + 조립제법으로 인수분해\n2) 복이차식 $$ax^4+bx^2+c=0$$: $$x^2=t$$ 치환\n3) 삼차 $$ax^3+bx^2+cx+d=0$$ 근과 계수: $$\\alpha+\\beta+\\gamma=-\\frac{b}{a},\\ \\alpha\\beta+\\beta\\gamma+\\gamma\\alpha=\\frac{c}{a},\\ \\alpha\\beta\\gamma=-\\frac{d}{a}$$\n4) 실계수 방정식의 허근은 켤레로 짝을 이룸\n5) $$x^3=1$$의 허근 $$\\omega$$: $$\\omega^2+\\omega+1=0,\\ \\omega^3=1$$',
  },
  '수학상_10일차부등식_통합숙제': {
    type: 'algebra',
    P: '연립일차부등식과 절댓값 기호를 포함한 일차부등식을 풀어 해의 범위를 구합니다.',
    C: '연립부등식은 각 부등식의 해의 공통범위를 찾습니다. 절댓값은 기준점으로 구간을 나누거나 절댓값의 성질을 이용해 푸는 것이 핵심입니다.',
    B: '일차부등식:\n\n1) 부등식 양변에 음수를 곱·나누면 부등호 방향이 바뀜\n2) 연립부등식: 각 해의 교집합(공통부분)\n3) $$|x|<a \\iff -a<x<a$$ (단 $$a>0$$)\n4) $$|x|>a \\iff x<-a$$ 또는 $$x>a$$\n5) 절댓값 안의 식이 0이 되는 점으로 구간을 나누어 처리',
  },
  '수학상_11이차부등식_통합숙제': {
    type: 'algebra',
    P: '이차부등식과 연립이차부등식을 풀고, 모든 실수에서 성립할 조건 등을 구합니다.',
    C: '이차부등식은 대응하는 이차함수의 그래프와 $$x$$축의 위치 관계로 해석합니다. "항상 성립" 조건은 판별식의 부호로 접근합니다.',
    B: '이차부등식 ($$a>0$$):\n\n1) $$ax^2+bx+c>0$$의 해는 그래프가 $$x$$축 위에 있는 구간\n2) 두 근 $$\\alpha<\\beta$$일 때: $$>0 \\Rightarrow x<\\alpha$$ 또는 $$x>\\beta$$, $$<0 \\Rightarrow \\alpha<x<\\beta$$\n3) 모든 실수에서 $$ax^2+bx+c>0$$: $$a>0$$ 이고 $$D<0$$\n4) 연립이차부등식: 각 해의 공통범위',
  },
  '수학상_12경우의수_통합숙제': {
    type: 'algebra',
    P: '합의 법칙과 곱의 법칙, 순열과 조합을 이용하여 경우의 수를 구합니다.',
    C: '동시에 일어나지 않으면 더하고(합), 잇따라 일어나면 곱합니다(곱). 순서가 중요하면 순열, 중요하지 않으면 조합으로 구분하는 것이 핵심입니다.',
    B: '경우의 수:\n\n1) 합의 법칙: 동시에 일어나지 않는 두 사건 $$m+n$$\n2) 곱의 법칙: 잇따라 일어나는 사건 $$m\\times n$$\n3) 순열: $$_n\\mathrm{P}_r = \\dfrac{n!}{(n-r)!}$$ (순서 O)\n4) 조합: $$_n\\mathrm{C}_r = \\dfrac{n!}{r!(n-r)!}$$ (순서 X)\n5) 같은 것이 있는 순열, 원순열 $$ (n-1)! $$ 등에 주의',
  },
  '수학상_13행렬_통합숙제': {
    type: 'algebra',
    P: '행렬의 덧셈·뺄셈·실수배·곱셈을 이용하여 행렬을 계산하고 미지수를 구합니다.',
    C: '행렬의 곱셈은 교환법칙이 성립하지 않음에 주의합니다. 두 행렬이 서로 같을 조건(대응 성분이 모두 같음)을 이용해 미지수를 구합니다.',
    B: '행렬의 연산:\n\n1) 합·차·실수배: 대응하는 성분끼리 계산\n2) 곱셈: $$(AB)_{ij} = \\sum_k a_{ik}b_{kj}$$ (앞 행렬의 행 × 뒤 행렬의 열)\n3) 일반적으로 $$AB \\neq BA$$ (교환법칙 성립 X)\n4) 분배법칙 $$A(B+C)=AB+AC$$, 결합법칙 성립\n5) 두 행렬이 같다 $$\\iff$$ 대응 성분이 모두 같다',
  },
...
const UNITS = [
  // 수학(상)
  { subject: '수학(상)', answerKey: '수학상_01다항식_통합숙제', title: '다항식', imagePath: '/math_crops/숙제/수학상/01다항식/' },
  { subject: '수학(상)', answerKey: '수학상_02나머지정리_통합숙제', title: '나머지정리', imagePath: '/math_crops/숙제/수학상/02나머지정리/' },
  { subject: '수학(상)', answerKey: '수학상_03인수분해_통합숙제', title: '인수분해', imagePath: '/math_crops/숙제/수학상/03인수분해/' },
  { subject: '수학(상)', answerKey: '수학상_04복소수_통합숙제', title: '복소수', imagePath: '/math_crops/숙제/수학상/04복소수/' },
  { subject: '수학(상)', answerKey: '수학상_05이차방정식_통합숙제', title: '이차방정식', imagePath: '/math_crops/숙제/수학상/05이차방정식/' },
  { subject: '수학(상)', answerKey: '수학상_06이차함수1번숙제_통합숙제', title: '이차함수 1', imagePath: '/math_crops/숙제/수학상/06이차함수1번숙제/' },
  { subject: '수학(상)', answerKey: '수학상_07이차함수2번숙제_통합숙제', title: '이차함수 2', imagePath: '/math_crops/숙제/수학상/07이차함수2번숙제/' },
  { subject: '수학(상)', answerKey: '수학상_08이차함수3번숙제_통합숙제', title: '이차함수 3', imagePath: '/math_crops/숙제/수학상/08이차함수3번숙제/' },
  { subject: '수학(상)', answerKey: '수학상_09고차방정식_통합숙제', title: '고차방정식', imagePath: '/math_crops/숙제/수학상/09고차방정식/' },
  { subject: '수학(상)', answerKey: '수학상_10일차부등식_통합숙제', title: '일차부등식', imagePath: '/math_crops/숙제/수학상/10일차부등식/' },
  { subject: '수학(상)', answerKey: '수학상_11이차부등식_통합숙제', title: '이차부등식', imagePath: '/math_crops/숙제/수학상/11이차부등식/' },
  { subject: '수학(상)', answerKey: '수학상_12경우의수_통합숙제', title: '경우의 수', imagePath: '/math_crops/숙제/수학상/12경우의수/' },
  { subject: '수학(상)', answerKey: '수학상_13행렬_통합숙제', title: '행렬', imagePath: '/math_crops/숙제/수학상/13행렬/' },
  // 수학1
...
UNITS.forEach(unit => {
  ...
  const outDir = path.join(__dirname, `../src/data/homework_avs/${hintKey}`);
  ...
  answerKeys.forEach(problemId => {
    ...
    // 해설 이미지 경로 (미적분 통합숙제는 +1 시프트: 문제 N 해설=(N+1)a.webp)
    const solShift = unit.imagePath.includes('숙제/미적분/') ? 1 : 0;
    const solPad = String(parseInt(problemId) + solShift).padStart(3, '0');
    const solutionImgSrc = `${unit.imagePath}${solPad}a.webp`;

    // 해설 이미지 존재 여부 — 노트북 원본(마운트)에서 확인
    const localImgPath = path.join('/Volumes/mentos_os_clean/public', solutionImgSrc);
    ...
    const json = {
      ...
      finalAnswer: String(answers[problemId]),
      correctAnswer: String(answers[problemId]),
