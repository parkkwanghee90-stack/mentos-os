...
export function progressToNextUnit(grade, currentProgress) {
  ...
  const mapping = {
    ...
    '[미적분] 수열의 극한': '1)극한2',
    '[미적분] 급수': '2)급수2',
    '[미적분] 지수로그함수의극한': '3)지수로그함수의극한',
    '[미적분] 삼각함수합성과미분': '4)삼각함수합성과미분',
    '[미적분] 여러가지미분법': '5)여러가지미분법2',
    '[미적분] 도함수의활용': '6)도함수의활용1',
    '[미적분] 여러가지적분': '7)여러가지적분',
    '[미적분] 정적분': '8)정적분',
    // ── 고3: 확률과통계 ──
    '[확통] 순열': '1)순열',
    ...
    '[확통] 이항정리': '3)이항정리',
    '[확통] 확률의뜻': '4)확률의뜻',
    '[확통] 덧셈정리·조건부확률': '5)덧셈정리_조건부확률_독립시행',
    '[확통] 확률변수와이항분포': '6)확률변수와이항분포',
    '[확통] 연속확률분포와정규분포': '7)연속확률분포와정규분포',
    '[확통] 표본평균과모평균': '8)표본평균과모평균',
    // ── 고3: 과목명 직접 선택 시 (첫 단원으로) ──
    '모의고사': '모의고사',
    '수1': '지수',
    '수2': '함수의 극한',
    '미적분': '1)극한2',
