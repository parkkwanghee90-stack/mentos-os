    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '800px', zIndex: 10 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          <p style={{ color: '#64748b', fontSize: '1.05rem', margin: 0 }}>멘토스 AI 서비스의 공정하고 투명한 이용 규칙을 안내해 드립니다</p>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: '1.25rem', fontWeight: '800', color: '#0f172a', borderLeft: '4px solid #6366f1', paddingLeft: '12px', margin: '0 0 1rem 0' }}>
            제 1 조 (목적)
          </h3>
